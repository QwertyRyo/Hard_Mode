    ...
    public static class GT03_gunnery_duel
    {
        public static List<SpawnEntry> Spawns() => new List<SpawnEntry>
        {
            ...
            new SpawnEntry
            {
                ...
                Position = new Vector3(2116.959f, 59.5284f, 1020.052f),
                Rotation = Quaternion.Euler(4.1881f, 301.7808f, 358.8218f),
            ...
            {
                PrefabName = "M60A1RISEP77",
                Position = new Vector3(2116.859f, 63.2284f, 986.8251f),
                Rotation = Quaternion.Euler(4.1881f, 301.7808f, 358.8218f),
                Allegiance = Faction.Blue,
            ...
            new SpawnEntry
            {
                ...
                Allegiance = Faction.Blue,
                DisplayName = "M2BRADLEY 1 modded",
                IsMobile = true,
                MobileDelay = 120f
            },
            new SpawnEntry
            {
                ...
                Allegiance = Faction.Blue,
                DisplayName = "M2BRADLEY 2 modded",
                IsMobile = true,
                MobileDelay = 120f
            },
            new SpawnEntry
            {
                ...
                Allegiance = Faction.Blue,
                DisplayName = "M2BRADLEY 3 modded",
                IsMobile = true,
                MobileDelay = 120f
            },
            new SpawnEntry
            {
                ...
                Allegiance = Faction.Blue,
                DisplayName = "M2BRADLEY 4 modded",
                IsMobile = true,
                MobileDelay = 120f
            },
        };
