  ...
  public static class GT03_Momentous_Maniac_UMC {
    public static List<SpawnEntry> Spawns() => new List<SpawnEntry> {
      new SpawnEntry { PrefabName = "T72M1",
                       ...
                       Allegiance = Faction.Red, DisplayName = "T72m1 1m",
                       IsMobile = true, MobileDelay = 240f },
      new SpawnEntry { PrefabName = "T72M1",
                       Position = new Vector3(3430.257f, 56.4234f, 69.4855f),
                       Rotation = Quaternion.Euler(359.5134f, 116.482f,
                                                   359.4353f),
                       Allegiance = Faction.Red, DisplayName = "T72m1 2m",
      ...
      new SpawnEntry { PrefabName = "T72M1",
                       ...
                       Allegiance = Faction.Red, DisplayName = "T-72m1 3m",
                       IsMobile = true, MobileDelay = 250f },
      new SpawnEntry { PrefabName = "BTR60PB",
                       Position = new Vector3(2053.345f, 54.3406f, -727.1251f),
                       Rotation = Quaternion.Euler(355.5145f, 163.0987f,
                                                   358.382f),
                       Allegiance = Faction.Red, DisplayName = "btr60 1m" },
      new SpawnEntry {
      ...
      new SpawnEntry { PrefabName = "T55A",
                       ...
                       Rotation = Quaternion.Euler(6.5417f, 84.7059f,
                                                   359.9877f),
                       Allegiance = Faction.Red, DisplayName = "t55a 1m",
                       IsMobile = true, MobileDelay = 45f },

      new SpawnEntry { PrefabName = "T55A",
                       Position = new Vector3(798.6627f, 94.6086f, -1222.823f),
                       Rotation = Quaternion.Euler(7.0884f, 49.0582f, 0.4184f),
                       Allegiance = Faction.Red, DisplayName = "t55a 2m",
                       IsMobile = true, MobileDelay = 55f },
      new SpawnEntry { PrefabName = "T55A",
