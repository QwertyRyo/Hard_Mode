...
namespace Hard_Mode {
  public static class GT03_Eastern_Scramble {
    public static List<SpawnEntry> Spawns() => new List<SpawnEntry> {
      ...
      new SpawnEntry {
        PrefabName = "M2BRADLEY", Position = new Vector3(-3490.294f, 192.1172f, -2243.555f),
        Rotation = Quaternion.Euler(355.653f, 165.053f, 3.5976f),
        Allegiance = Faction.Blue, DisplayName = "BRAD 1m", IsMobile = true,
        MobileDelay = 600f
      },
      new SpawnEntry { PrefabName = "M2BRADLEY",
                       Position = new Vector3(-3491.177f, 190.609f, -2226.238f),
                       Rotation = Quaternion.Euler(356.5275f, 168.8745f, 5.496f),
                       Allegiance = Faction.Blue, DisplayName = "BRAD 2m",
                       IsMobile = true, MobileDelay = 610f },
                             ...
                             new SpawnEntry {
        PrefabName = "MARDER1A2", Position = new Vector3(-3457.476f, 184.5877f, -2182.225f),
        Rotation = Quaternion.Euler(358.8782f, 145.8282f, 4.4859f),
        Allegiance = Faction.Blue, DisplayName = "MARDER 1m", IsMobile = true,
        MobileDelay = 300f
        //350f
      },
      new SpawnEntry { PrefabName = "MARDER1A2",
                       Position = new Vector3(-3464.945f, 184.8303f, -2170.896f),
                       Rotation = Quaternion.Euler(357.3311f, 145.7872f, 5.5868f),
                       Allegiance = Faction.Blue, DisplayName = "MARDER 2m",
                       IsMobile = true, MobileDelay = 325f },
