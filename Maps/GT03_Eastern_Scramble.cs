  ...
  public static class GT03_Eastern_Scramble {
    public static List<SpawnEntry> Spawns() => new List<SpawnEntry> {
      ...
      new SpawnEntry {
        ...
        Allegiance = Faction.Red, DisplayName = "m60a1 1m", IsMobile = true,
        MobileDelay = 600f
      },
      new SpawnEntry { PrefabName = "M60A1RISEP77",
                       ...
                       Allegiance = Faction.Red, DisplayName = "m60a1 2m",
        ...
        Allegiance = Faction.Red, DisplayName = "leo 1m", IsMobile = true,
        MobileDelay = 5f
        //350f
      },
      new SpawnEntry { PrefabName = "LEO1A3",
                       ...
                       Allegiance = Faction.Red, DisplayName = "leo 2m",
                       IsMobile = true, MobileDelay = 1003f },


                             new SpawnEntry {
        PrefabName = "M1", Position = new Vector3(-3355.808f, 157.9925f, -1922.201f),
        Rotation = Quaternion.Euler(2.0255f, 9.7347f, 353.8893f),
        Allegiance = Faction.Red, DisplayName = "m1 1m", IsMobile = true,
        MobileDelay = 1070f
      },
        ...
        Allegiance = Faction.Red, DisplayName = "m113 1m", IsMobile = true,
        MobileDelay = 1040f
      },
